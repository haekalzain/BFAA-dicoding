...
import com.example.githubusersubmission3.presentation.adapter.FollowingAdapter
import com.example.githubusersubmission3.viewmodel.FollowingViewModel
...
class FollowingFragment : Fragment() {
    ...
    private fun configRecyclerView() {
        ...
        followingRecyclerView.layoutManager = GridLayoutManager(activity, width / 375)
